...
ax.set_title('-50 MSE平流强度下OLR对SST敏感度关系',fontsize=20)
...
fig.savefig('D:\\desktopppp\\sst_olr\\picture\\'+'-50mse.tiff',format='tiff',dpi=150)

d={'-50mse':olr_mean}
df=pd.DataFrame(d)  
df.to_csv('D:\\desktopppp\\sst_olr\\'+'-50mse.csv') 
d1={'-50diff':diff}
df1=pd.DataFrame(d1)  
df1.to_csv('D:\\desktopppp\\sst_olr\\'+'-50diff.csv') 